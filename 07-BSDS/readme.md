...
# in the script main.py is the code for the segmentations for the two proposed methods. And in matlab it is only needed to run the plot_eval function, with the directories.
